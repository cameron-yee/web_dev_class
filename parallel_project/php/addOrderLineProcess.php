...
$messageToBusiness = 
    ...
    "Number Ordered: $_POST[NumOrdered]\r\n";

//Send e-mail feedback message to the business
$headerToBusiness = "From: $_POST[email]\r\n";
mail("cyee@uccs.edu", "New Order Line Record Added to CamBam's Bikes",
    $messageToBusiness);
...
$messageToClient =
    "The following order line record was added to CamBam's Bikes:\r\n".
    $messageToBusiness;

//Sends e-mail confirmation message to the client
$headerToClient = "From: cyee@uccs.edu\r\n";
mail($_POST['email'], "New Order Line Record Added to CamBam's Bikes",
...
$fileVar = fopen("../data/order-line-record.txt", "a")
