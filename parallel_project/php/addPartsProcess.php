...
$messageToClient =
    "The following part was added to CamBam's Bikes:\r\n".
    $messageToBusiness;

//Sends e-mail confirmation message to the client
$headerToClient = "From: cyee@uccs.edu\r\n";
mail($_POST['email'], "New Part Added to CamBam's Bikes",
...
$fileVar = fopen("../data/parts.txt", "a")
