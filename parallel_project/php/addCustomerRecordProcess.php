...
mail("cyee@uccs.edu", "New Customer Record Added to CamBam's Bikes",
    $messageToBusiness);
...
$messageToClient =
    "The following customer record was added to CamBam's Bikes:\r\n".
    $messageToBusiness;

//Sends e-mail confirmation message to the client
$headerToClient = "From: cyee@uccs.edu\r\n";
mail($_POST['email'], "New Customer Record Added to CamBam's Bikes",
...
$fileVar = fopen("../data/customer-record.txt", "a")
